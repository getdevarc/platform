...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#060606] text-white selection:bg-primary selection:text-primary-foreground font-sans">
      
      {/* 1. FLOATING HEADER */}
      <header className="fixed top-0 left-0 w-full z-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-3 rounded-full border border-white/5 bg-zinc-950/60 backdrop-blur-lg shadow-xl shadow-black/40">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a href="#different" className="text-xs text-zinc-400 hover:text-white font-medium uppercase tracking-wider transition-colors">Differentiation</a>
            <a href="#lifecycle" className="text-xs text-zinc-400 hover:text-white font-medium uppercase tracking-wider transition-colors">Developer Loop</a>
            <a href="#previews" className="text-xs text-zinc-400 hover:text-white font-medium uppercase tracking-wider transition-colors">Product Preview</a>
            <a href="#faq" className="text-xs text-zinc-400 hover:text-white font-medium uppercase tracking-wider transition-colors">FAQ</a>
          </nav>
          ...
          <div className="flex items-center gap-3">
            {loading ? (
              ...
              <Button 
                ...
                className="h-9 px-4 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold uppercase tracking-widest text-[10px]"
              >
                Go to Workspace <ArrowRight size={12} className="ml-1" />
              </Button>
            ) : (
              <>
                <Link href="/login" className="text-xs text-zinc-400 hover:text-white font-bold uppercase tracking-widest px-3">
                  Sign In
                </Link>
                <Button 
                  onClick={() => router.push("/register")}
                  className="h-9 px-4 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground font-bold uppercase tracking-widest text-[10px] shadow-lg shadow-primary/10"
                >
                  Join Waiting List
                </Button>
              </>
      ...
      <section className="relative pt-32 pb-24 px-6 overflow-hidden">
        {/* Glow Spheres */}
        <div className="absolute top-[20%] left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-primary/10 rounded-full blur-[160px] -z-10" />
        <div className="absolute top-0 left-0 w-full h-[600px] bg-[radial-gradient(circle_at_50%_0%,_#111111,_transparent_60%)] -z-15" />
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white leading-tight">
            ...
            <span className="bg-gradient-to-r from-primary via-emerald-400 to-primary bg-clip-text text-transparent italic font-serif">
              Model your career.
            </span>
          </h1>
          
          <p className="text-zinc-405 text-sm sm:text-lg max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button
              ...
              size="lg"
              className="h-12 px-6 rounded-xl bg-primary hover:bg-primary/95 text-primary-foreground font-bold uppercase tracking-widest text-xs shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-transform w-full sm:w-auto"
            >
              Launch Your Copilot
            </Button>
            <a
              href="#previews"
              className="h-12 px-6 rounded-xl bg-zinc-900/50 hover:bg-zinc-900 border border-white/5 hover:border-white/10 text-zinc-400 hover:text-white font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 transition-colors w-full sm:w-auto"
            >
      ...
      <section id="different" className="py-20 px-6 border-y border-white/5 bg-zinc-950/20 relative">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 rounded-2xl border border-rose-500/10 bg-rose-950/5 space-y-4">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-rose-500 px-2 py-0.5 rounded bg-rose-500/10">Traditional Platforms</span>
              <h3 className="text-lg font-bold text-zinc-300">Rote Grinding & Disconnection</h3>
            ...
            <div className="p-6 rounded-2xl border border-emerald-500/20 bg-emerald-950/5 space-y-4 shadow-lg shadow-emerald-500/5">
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-emerald-450 px-2 py-0.5 rounded bg-emerald-950/30">The DevArc Way</span>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                Unified AI Career Loop <Sparkles size={16} className="text-emerald-400" />
              </h3>
      ...
      <section id="lifecycle" className="py-20 px-6">
        <div className="max-w-6xl mx-auto space-y-16">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl font-extrabold text-white">Inside the Developer Lifecycle</h2>
            <p className="text-zinc-500 text-xs sm:text-sm max-w-md mx-auto">Four integrated modules working together to accelerate your professional growth.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              return (
                <div key={idx} className="p-6 rounded-2xl border border-white/5 bg-zinc-950/20 space-y-4 hover:border-primary/20 transition-colors">
                  <div className="flex items-center justify-between">
                    <span className="text-2xl font-black text-zinc-800">{step.num}</span>
      ...
      <section id="previews" className="py-24 px-6 border-t border-white/5 bg-zinc-950/10">
        <div className="max-w-6xl mx-auto space-y-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-2">
              ...
              <h2 className="text-3xl font-extrabold text-white">Experience the Copilot Workspace</h2>
              <p className="text-zinc-500 text-xs sm:text-sm max-w-md">Click tabs to query other sections and see exact UI mockups.</p>
            </div>
            
            <div className="flex gap-2 p-1.5 rounded-xl bg-zinc-950 border border-white/5 shrink-0 self-start md:self-end">
              {(["roadmap", "workspace", "interview"] as const).map((tab) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeTab === tab ? "bg-primary text-primary-foreground" : "text-zinc-500 hover:text-white"
                  )}
                >
                  {tab}
                </button>
          ...
          <div className="p-6 rounded-3xl border border-white/5 bg-[#0b0b0b] shadow-2xl relative overflow-hidden min-h-[400px] flex items-center justify-center">
              ...
              <div className="w-full space-y-6 animate-in fade-in duration-300">
                <div className="flex items-center justify-between border-b border-white/5 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-zinc-300">Target: Senior Full-Stack Engineer</span>
                  </div>
                  <span className="text-[10px] font-extrabold text-emerald-450 uppercase tracking-widest bg-emerald-500/10 px-2 py-0.5 rounded">
                    Roadmap Progress: 64% Completed
                  </span>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 rounded-xl border border-emerald-500/20 bg-emerald-950/5 space-y-2">
                    <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-wider text-zinc-500">
                      <span>Module 1</span>
                      <span className="text-emerald-450 font-extrabold">Complete</span>
                    </div>
                    <h4 className="text-sm font-bold text-white">DSA Fundamentals (Trees & Graphs)</h4>
                    <p className="text-[11px] text-zinc-400">Master recursive iterations, graph node connectivity and traversals.</p>
                  </div>

                  <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 space-y-2 relative">
                    ...
                    <h4 className="text-sm font-bold text-white">Advanced System Design</h4>
                    <p className="text-[11px] text-zinc-400">Understand message broker queues, caching invalidation and replication strategies.</p>
                  </div>

                  <div className="p-4 rounded-xl border border-white/5 bg-zinc-900/20 space-y-2 opacity-50">
                    <div className="flex justify-between items-center text-[10px] font-bold uppercase tracking-wider text-zinc-500">
                      <span>Module 3</span>
                      <span>Locked</span>
                    </div>
                    <h4 className="text-sm font-bold text-white">Deployment & CI/CD Pipelines</h4>
                    <p className="text-[11px] text-zinc-400">Deploy docker containers atomically and configure fail-safe AWS SSM scripts.</p>
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="w-full space-y-4 animate-in fade-in duration-300 font-mono">
                <div className="flex items-center justify-between border-b border-white/5 pb-3">
                  <div className="flex items-center gap-2 font-sans">
                    ...
                    <span className="text-xs font-bold text-zinc-300">Problem: Longest Substring Without Repeating Characters</span>
                  </div>
                  <div className="flex gap-2">
                    <span className="text-[9px] font-bold uppercase bg-zinc-900 border border-white/5 px-2 py-0.5 rounded text-zinc-450">JavaScript</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                  ...
                  <div className="lg:col-span-4 bg-zinc-900/50 p-4 rounded-xl border border-primary/20 space-y-3 font-sans">
                    ...
                    <div className="flex gap-1.5">
                      ...
                      <span className="text-[8px] font-bold uppercase px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-450">Review Code</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full space-y-6 animate-in fade-in duration-300">
                <div className="flex items-center justify-between border-b border-white/5 pb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold uppercase tracking-wider text-zinc-350">Live VOICE Assessment Session</span>
                  </div>
                  <span className="text-[10px] font-bold text-red-500 bg-red-550/10 px-2 py-0.5 rounded animate-pulse">● Recording Waveforms</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 rounded-xl border border-white/5 bg-zinc-950 flex flex-col justify-between min-h-[150px]">
                    ...
                    <div className="flex items-center gap-1 mt-4">
                      ...
                      <span className="text-[9px] font-medium text-zinc-400 ml-2">User speaking...</span>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl border border-primary/20 bg-primary/5 space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center">
                      <div className="bg-zinc-900/60 p-2.5 rounded-lg">
                        <span className="block text-lg font-black text-white">88%</span>
                        <span className="text-[8px] text-zinc-500 uppercase font-medium">Logic</span>
                      </div>
                      <div className="bg-zinc-900/60 p-2.5 rounded-lg">
                        <span className="block text-lg font-black text-white">92%</span>
                        <span className="text-[8px] text-zinc-500 uppercase font-medium">Code Quality</span>
                      </div>
                      <div className="bg-zinc-900/60 p-2.5 rounded-lg">
                        <span className="block text-lg font-black text-white">79%</span>
                        <span className="text-[8px] text-zinc-500 uppercase font-medium">Comm.</span>
                      </div>
                    </div>
      ...
      {/* 6. STATISTICS & TRUST */}
      <section className="py-20 px-6 border-y border-white/5 bg-[#090909]">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="text-center space-y-1">
              <span className="block text-3xl font-extrabold text-white tracking-tighter">{stat.metric}</span>
              <span className="block text-[10px] text-zinc-500 uppercase font-bold tracking-widest">{stat.label}</span>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto space-y-10">
          ...
          <div className="space-y-3">
            {FAQS.map((faq, idx) => (
              <div 
                key={idx} 
                className="rounded-2xl border border-white/5 bg-zinc-950/20 overflow-hidden transition-all duration-300"
              >
                <button
                  onClick={() => setExpandedFaq(expandedFaq === idx ? null : idx)}
                  className="w-full flex items-center justify-between p-5 text-left text-xs font-bold uppercase tracking-wider text-zinc-350 hover:text-white"
                >
                  <span>{faq.q}</span>
                  <ChevronDown 
                    size={16} 
                    className={cn("text-zinc-500 transition-transform duration-300", expandedFaq === idx ? "rotate-180" : "")} 
                  />
                </button>
                ...
                <AnimatePresence initial={false}>
                  {expandedFaq === idx && (
                    ...
                    >
                      <p className="px-5 pb-5 text-xs text-zinc-400 leading-relaxed max-w-2xl font-medium">
                        {faq.a}
                      </p>
                    </motion.div>
                  )}
      ...
      <section className="py-24 px-6 border-t border-white/5 bg-gradient-to-b from-[#060606] to-[#0a0a0a] relative">
        <div className="max-w-4xl mx-auto rounded-3xl border border-primary/20 bg-primary/5 p-8 md:p-12 text-center space-y-6 relative overflow-hidden">
          ...
          <span className="text-[10px] font-extrabold uppercase tracking-widest text-primary inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/5">
          ...
          <p className="text-xs sm:text-sm text-zinc-460 max-w-lg mx-auto">
      ...
      {/* 9. FOOTER */}
      <footer className="py-12 border-t border-white/5 bg-[#050505] text-zinc-550 text-xs">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <div className="h-6 w-6 bg-zinc-800 rounded-lg flex items-center justify-center text-white font-black text-xs">
              DA
            </div>
            <span className="font-bold tracking-tight text-zinc-400">DevArc Platform</span>
          </div>

          <p className="text-center md:text-left text-[11px] font-medium uppercase tracking-wider text-zinc-600">
