        ...
        <div className="w-full max-w-sm space-y-6 z-10">
          ...
          <Card className="border border-border bg-card/40 backdrop-blur-xl shadow-2xl rounded-2xl">
            <CardHeader className="space-y-1 pb-4">
              <CardTitle className="text-xl font-bold tracking-tight text-foreground hidden lg:block">Welcome Back</CardTitle>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex flex-col gap-4 mt-2">
                ...
                <div className="relative flex items-center justify-center w-full my-1">
                  ...
                  <span className="relative px-3 bg-card dark:bg-[#0c0c0c] font-bold uppercase tracking-widest text-[9px] text-muted-foreground">or continue with</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3 w-full">
                  <Button
                    type="button"
                    variant="outline"
                    className="h-10 border-border bg-secondary/30 hover:bg-secondary/60 text-muted-foreground hover:text-foreground rounded-xl text-xs flex items-center justify-center gap-2"
                  >
