    ...
    <>
      <nav className="h-16 border-b border-white/5 bg-black/50 backdrop-blur-md sticky top-0 z-[100] px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden lg:flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-[10px] font-bold uppercase tracking-widest animate-pulse">
            <Sparkles size={10} />
            AI Coach Active
          </div>
